 ...
 */
export type ProviderInstance<T> = T extends {
  llm: infer P;
}
  ? P
  : never;
 ...
 * Model type helper
 */
export type ModelType<T> = T extends {
  llm: LLMProvider<any>;
}
 ...
 */
export type InferGenerateTextResponse<
  T extends {
    llm: LLMProvider<any>;
  },
 ...
 */
export type InferStreamTextResponse<
  T extends {
    llm: LLMProvider<any>;
  },
 ...
 */
export type InferGenerateObjectResponse<
  T extends {
    llm: LLMProvider<any>;
  },
 ...
 */
export type InferStreamObjectResponse<
  T extends {
    llm: LLMProvider<any>;
  },
 ...
 */
export type ProviderType<T> = T extends {
  llm: LLMProvider<infer P>;
}
  ? P
  : never;
/**
...
export type AgentOperationOutput =
  ...
  | StandardizedObjectResult<unknown>
  | StreamObjectFinishResult<unknown>;
