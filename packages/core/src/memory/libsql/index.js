    ...
    if (url.startsWith("file:")) {
      ...
      if (!filePath.includes("/") && !filePath.includes("\\")) {
        try {
          ...
          const dirPath = (0, node_path_1.join)(process.cwd(), ".voltagent");
          if (!(0, node_fs_1.existsSync)(dirPath)) {
            node_fs_2.default.mkdirSync(dirPath, { recursive: true });
          }
          return `file:${(0, node_path_1.join)(dirPath, filePath)}`;
        } catch (error) {
...
exports.LibSQLStorage = LibSQLStorage;
